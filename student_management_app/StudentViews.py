...
def student_home(request):
    ...
    attendance = int(attendance_present/total_attendance) * 100 if (total_attendance) > 0 else 0
    if attendance > 80: color = "success"
    elif attendance > 75: color = "warning"
    elif attendance < 75: color = "danger"
